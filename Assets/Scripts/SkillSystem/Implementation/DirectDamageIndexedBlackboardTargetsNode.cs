...
[CreateAssetMenu(fileName = "DirectDamageIndexedBlackboardTargetsNode", menuName = "SkillSystem/Effects/Common/Direct Damage Indexed Blackboard Targets")]
public sealed class DirectDamageIndexedBlackboardTargetsNode : SkillEffectNode
{
    [TitleGroup("目标"), LabelText("数量键")]
    public string CountKey = "Targets.Count";

    [TitleGroup("目标"), LabelText("目标前缀")]
