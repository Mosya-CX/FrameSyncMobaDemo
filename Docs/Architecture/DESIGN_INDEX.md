...
| Presentation | `Docs/Design/moba_presentation_layer_integrated_design_v13_2_fifth_round_audio_entry.md` | Current + D-048 amendment | Visual snapshots, event identity, attack SFX, presentation rollback, local Addressables client views and Dedicated Server presentation exclusion |
...
| Logical prefab / local client-view resource boundary | Presentation v13.2 + D-048 |
